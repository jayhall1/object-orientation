...
favoriteThings.car = "mazda rx8"
favoriteThings.show = "gintama"
...
function ingredients(objects) {
  var {carb, fat, protein} = objects;
  let snacksArr = []
  for(let key in objects) {
    snacksArr.push(objects[key])
  }
  return snacksArr;
}
let dinner = {
...
let sphynx = new cat("sphynx", 2000, "black");
console.log(sphynx.name);
...
let magician = new Wizard('alladin', 16, 'magoi manipulation')
...
let samsung = new phone('samsung', 'galaxy S', 30, 'grey', 300);
let iphone = new phone('iphone', '12xs', 60, 'pink', 900);
let blackbery = new phone('blackbery', 'touch', 10, 'black', 100);
...
blackbery.changePrice(35.99);
console.log(blackbery);
...
myFirstVehicle = new vehicle(2, 'black', 10000000);
